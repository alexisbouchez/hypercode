...
export class Memory {
  ...
  read32(addr: number): number {
    return this.view.getInt32(this.offset(addr), true);
  }
  ...
  readU64(addr: number): bigint {
    return this.view.getBigUint64(this.offset(addr), true);
  }

  writeU64(addr: number, value: bigint) {
    this.view.setBigUint64(this.offset(addr), BigInt.asUintN(64, value), true);
  }
