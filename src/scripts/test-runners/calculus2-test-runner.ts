import { calculus2Lessons } from "@/lib/lessons/calculus2/index";
...
export async function runCalculus2Tests(): Promise<LessonTestResult[]> {
	await initTCC();

	const results: LessonTestResult[] = [];

	for (const lesson of calculus2Lessons) {
