...
import { sqliteLessons } from "@/lib/lessons/sqlite/index";
...
function execSql(
  ...
  // Split on semicolons, filtering empty chunks
...
export function runSqliteTests(): LessonTestResult[] {
    ...
    for (const test of lesson.tests) {
      try {
        ...
        try {
          ...
          if (test.code) {
            // DDL/DML exercise: test.code contains setup + validation separated by ---VALIDATE---
            ...
            // Standard query exercise (may have multiple statements)
