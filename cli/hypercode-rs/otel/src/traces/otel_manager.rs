...
impl OtelManager {
    ...
    pub fn conversation_starts(
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "hypercode.conversation_starts",
    ...
    pub fn record_api_request(
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "hypercode.api_request",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
    ...
    fn sse_event(&self, kind: &str, duration: Duration) {
        tracing::event!(
            tracing::Level::INFO,
            event.name = "hypercode.sse_event",
            event.timestamp = %timestamp(),
            event.kind = %kind,
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
    ...
    pub fn user_prompt(&self, items: &[UserInput]) {
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "hypercode.user_prompt",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
    ...
    pub fn tool_decision(
        ...
        tracing::event!(
            tracing::Level::INFO,
            event.name = "hypercode.tool_decision",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
    ...
    pub fn log_tool_failed(&self, tool_name: &str, error: &str) {
        tracing::event!(
            tracing::Level::INFO,
            event.name = "hypercode.tool_result",
            event.timestamp = %timestamp(),
            conversation.id = %self.metadata.conversation_id,
            app.version = %self.metadata.app_version,
            auth_mode = self.metadata.auth_mode,
