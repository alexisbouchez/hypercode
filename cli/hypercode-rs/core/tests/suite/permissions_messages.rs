...
async fn resume_replays_permissions_messages() -> Result<()> {
    ...
    initial
        ...
        .await?;
    wait_for_event(&initial.hypercode, |ev| matches!(ev, EventMsg::TurnComplete(_))).await;
    ...
    resumed
        ...
        .await?;
    wait_for_event(&resumed.hypercode, |ev| matches!(ev, EventMsg::TurnComplete(_))).await;
