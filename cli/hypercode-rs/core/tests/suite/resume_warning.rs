...
use hypercode_core::protocol::InitialHistory;
use hypercode_core::protocol::ResumedHistory;
use hypercode_core::protocol::RolloutItem;
use hypercode_core::protocol::TurnContextItem;
...
fn resume_history(
    config: &hypercode_core::config::Config,
    previous_model: &str,
