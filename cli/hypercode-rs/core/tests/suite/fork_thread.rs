...
use hypercode_core::parse_turn_item;
...
async fn fork_thread_twice_drops_to_first_message() {
    ...
    // Configure Hypercode to use the mock server.
    ...
    let base_path = hypercode.rollout_path();
    ...
    let fork1_path = hypercode_fork1.rollout_path();
    ...
    let fork2_path = hypercode_fork2.rollout_path();
