...
use hypercode_otel::config::OtelTlsConfig as OtelTlsSettings;
...
pub fn build_provider(
    ...
    OtelProvider::from(&OtelSettings {
        ...
        hypercode_home: config.hypercode_home.clone(),
...
/// Filter predicate for exporting only Hypercode-owned events via OTEL.
/// Keeps events that originated from hypercode_otel module
pub fn hypercode_export_filter(meta: &tracing::Metadata<'_>) -> bool {
    meta.target().starts_with("hypercode_otel")
}
