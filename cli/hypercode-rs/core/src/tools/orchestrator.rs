...
use hypercode_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
    ...
    pub async fn run<Rq, Out, T>(
        ...
        req: &Rq,
        tool_ctx: &ToolCtx<'_>,
        turn_ctx: &crate::hypercode::TurnContext,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            hypercode_linux_sandbox_exe: turn_ctx.hypercode_linux_sandbox_exe.as_ref(),
        };
        ...
        match tool.run(req, &initial_attempt, tool_ctx).await {
            ...
            Err(ToolError::Hypercode(HypercodeErr::Sandbox(SandboxErr::Denied { output }))) => {
                if !tool.escalate_on_failure() {
                    return Err(ToolError::Hypercode(HypercodeErr::Sandbox(SandboxErr::Denied {
                        output,
                    })));
                }
