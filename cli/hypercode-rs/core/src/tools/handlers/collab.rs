...
use hypercode_protocol::protocol::CollabAgentInteractionBeginEvent;
use hypercode_protocol::protocol::CollabAgentInteractionEndEvent;
use hypercode_protocol::protocol::CollabAgentSpawnBeginEvent;
use hypercode_protocol::protocol::CollabAgentSpawnEndEvent;
use hypercode_protocol::protocol::CollabCloseBeginEvent;
use hypercode_protocol::protocol::CollabCloseEndEvent;
use hypercode_protocol::protocol::CollabWaitingBeginEvent;
use hypercode_protocol::protocol::CollabWaitingEndEvent;
...
fn collab_spawn_error(err: HypercodeErr) -> FunctionCallError {
    match err {
...
fn collab_agent_error(agent_id: ThreadId, err: HypercodeErr) -> FunctionCallError {
    match err {
        HypercodeErr::ThreadNotFound(id) => {
...
fn build_agent_spawn_config(turn: &TurnContext) -> Result<Config, FunctionCallError> {
    ...
    config.hypercode_linux_sandbox_exe = turn.hypercode_linux_sandbox_exe.clone();
...
mod tests {
    ...
    fn invocation(
        session: Arc<crate::hypercode::Session>,
        turn: Arc<TurnContext>,
        tool_name: &str,
        payload: ToolPayload,
    ) -> ToolInvocation {
    ...
    async fn build_agent_spawn_config_uses_turn_context_values() {
        ...
        turn.hypercode_linux_sandbox_exe = Some(PathBuf::from("/bin/echo"));
        ...
        expected.hypercode_linux_sandbox_exe = turn.hypercode_linux_sandbox_exe.clone();
