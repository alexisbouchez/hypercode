...
use hypercode_protocol::models::VIEW_IMAGE_TOOL_NAME;
...
impl ToolsConfig {
    pub fn new(params: &ToolsConfigParams) -> Self {
        ...
        let shell_type = if !features.enabled(Feature::ShellTool) {
            ...
            if hypercode_utils_pty::conpty_supported() {
...
fn create_test_sync_tool() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Internal synchronization helper used by Hypercode integration tests.".to_string(),
        strict: false,
        parameters: JsonSchema::Object {
            properties,
            required: None,
...
mod tests {
    ...
    #[test]
    fn test_full_toolset_specs_for_gpt5_hypercode_unified_exec_web_search() {
        let config = test_config();
        let model_info = ModelsManager::construct_model_info_offline("gpt-5-hypercode", &config);
    ...
    #[test]
    fn test_build_specs_gpt5_hypercode_default() {
        assert_model_tools(
            "gpt-5-hypercode",
    ...
    #[test]
    fn test_build_specs_gpt51_hypercode_default() {
        assert_model_tools(
            "gpt-5.1-codex",
            &Features::with_defaults(),
            WebSearchMode::Cached,
    ...
    #[test]
    fn test_build_specs_gpt5_hypercode_unified_exec_web_search() {
        assert_model_tools(
            "gpt-5-hypercode",
    ...
    #[test]
    fn test_build_specs_gpt51_hypercode_unified_exec_web_search() {
        assert_model_tools(
            "gpt-5.1-codex",
            Features::with_defaults().enable(Feature::UnifiedExec),
            WebSearchMode::Live,
    ...
    #[test]
    fn test_hypercode_mini_defaults() {
        assert_model_tools(
            "hypercode-mini-latest",
            &Features::with_defaults(),
            WebSearchMode::Cached,
            &[
                "local_shell",
    ...
    #[test]
    fn test_hypercode_5_1_mini_defaults() {
        assert_model_tools(
            "gpt-5.1-codex-mini",
            &Features::with_defaults(),
            WebSearchMode::Cached,
    ...
    #[test]
    fn test_hypercode_mini_unified_exec_web_search() {
        assert_model_tools(
            "hypercode-mini-latest",
            Features::with_defaults().enable(Feature::UnifiedExec),
            WebSearchMode::Live,
    ...
    fn test_test_model_info_includes_sync_tool() {
        let config = test_config();
        let model_info = ModelsManager::construct_model_info_offline("test-gpt-5-hypercode", &config);
        let features = Features::with_defaults();
        let tools_config = ToolsConfig::new(&ToolsConfigParams {
            model_info: &model_info,
            features: &features,
