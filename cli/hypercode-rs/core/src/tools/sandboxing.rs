...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and hypercode prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub hypercode_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
}
...
impl<'a> SandboxAttempt<'a> {
    pub fn env_for(
        ...
        self.manager.transform(
            ...
            self.sandbox,
            self.sandbox_cwd,
            self.hypercode_linux_sandbox_exe,
        )
    }
}
...
mod tests {
    use super::*;
    use hypercode_protocol::protocol::NetworkAccess;
