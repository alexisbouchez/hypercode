...
pub use hypercode_protocol::config_types::AltScreenMode;
pub use hypercode_protocol::config_types::WebSearchMode;
...
pub struct McpServerConfig {
    ...
    /// When `false`, Hypercode skips initializing this MCP server.
...
pub struct AnalyticsConfigToml {
    /// When `false`, disables analytics across Hypercode product surfaces in this profile.
    pub enabled: Option<bool>,
}
...
pub struct FeedbackConfigToml {
    /// When `false`, disables the feedback flow across Hypercode product surfaces.
    pub enabled: Option<bool>,
}
...
/// button events, without a magnitude. This setting controls whether Hypercode uses a heuristic to
...
pub struct Tui {
    ...
    /// See `hypercode-rs/tui2/docs/scroll_input_model.md` for the probe data and rationale.
    ...
    ///
    /// See `hypercode-rs/tui2/docs/scroll_input_model.md` for details on the stream model and the
...
/// (primarily the Hypercode IDE extension). NOTE: these are different from
...
pub struct Notice {
    ...
    pub hide_gpt_5_1_hypercode_max_migration_prompt: Option<bool>,
...
impl From<SandboxWorkspaceWrite> for hypercode_app_server_protocol::SandboxSettings {
