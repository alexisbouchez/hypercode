    ...
    P: AsRef<Path>,
{
    ...
    let arg0 = Some("hypercode-linux-sandbox");
    spawn_child_async(
        hypercode_linux_sandbox_exe.as_ref().to_path_buf(),
        args,
        arg0,
        command_cwd,
        sandbox_policy,
...
/// Converts the sandbox policy into the CLI invocation for `hypercode-linux-sandbox`.
