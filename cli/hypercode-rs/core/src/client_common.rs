...
pub use hypercode_api::common::ResponseEvent;
...
#[cfg(test)]
mod tests {
    use hypercode_api::ResponsesApiRequest;
    use hypercode_api::common::OpenAiVerbosity;
    use hypercode_api::common::TextControls;
    ...
    fn serializes_text_schema_with_strict_format() {
        ...
        assert_eq!(
            format.get("name"),
            Some(&serde_json::Value::String("hypercode_output_schema".into()))
        );
        assert_eq!(
            format.get("type"),
