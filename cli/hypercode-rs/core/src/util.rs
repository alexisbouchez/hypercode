...
/// `hypercode_feedback::HypercodeFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// ```rust
/// hypercode_core::feedback_tags!(model = "gpt-5", cached = true);
/// hypercode_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
