...
pub enum Feature {
    ...
    PowershellUtf8,
    /// Compress request bodies (zstd) when sending streaming requests to hypercode-backend.
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Beta {
            ...
            announcement: "NEW! Try shell snapshotting to make your Hypercode faster. Enable in /experimental!",
        },
        default_enabled: false,
    },
    FeatureSpec {
