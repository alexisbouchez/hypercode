...
use hypercode_file_search as file_search;
...
pub(crate) async fn get_threads(
    ...
    let mut root = hypercode_home.to_path_buf();
...
///
/// Directory layout: `~/.hypercode/sessions/YYYY/MM/DD/rollout-YYYY-MM-DDThh-mm-ss-<uuid>.jsonl`
