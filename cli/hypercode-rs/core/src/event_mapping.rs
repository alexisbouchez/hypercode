...
use hypercode_protocol::models::is_image_close_tag_text;
use hypercode_protocol::models::is_image_open_tag_text;
use hypercode_protocol::models::is_local_image_close_tag_text;
use hypercode_protocol::models::is_local_image_open_tag_text;
...
mod tests {
    ...
    fn skips_local_image_label_text() {
        ...
        let label = hypercode_protocol::models::local_image_open_tag_text(1);
    ...
    fn skips_unnamed_image_label_text() {
        let image_url = "data:image/png;base64,abc".to_string();
        let label = hypercode_protocol::models::image_open_tag_text();
        let user_text = "Please review this image.".to_string();
        ...
        let item = ResponseItem::Message {
            ...
            content: vec![
                ...
                ContentItem::InputText {
                    text: hypercode_protocol::models::image_close_tag_text(),
                },
                ContentItem::InputText {
                    text: user_text.clone(),
                },
    ...
    fn parses_agent_message() {
        let item = ResponseItem::Message {
            ...
            content: vec![ContentItem::OutputText {
                text: "Hello from Hypercode".to_string(),
            }],
        };
        ...
        match turn_item {
            TurnItem::AgentMessage(message) => {
                ...
                assert_eq!(text, "Hello from Hypercode");
            }
