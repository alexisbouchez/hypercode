...
use hypercode_protocol::protocol::AgentMessageContentDeltaEvent;
use hypercode_protocol::protocol::AgentMessageDeltaEvent;
use hypercode_protocol::protocol::Event;
use hypercode_protocol::protocol::EventMsg;
use hypercode_protocol::protocol::ExitedReviewModeEvent;
...
use crate::hypercode_delegate::run_hypercode_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        let _ = session
            ...
            .services
            .otel_manager
            .counter("hypercode.task.review", 1, &[]);

        // Start sub-hypercode conversation and get the receiver for events.
