...
use hypercode_protocol::protocol::AgentReasoningEvent;
use hypercode_protocol::protocol::AgentReasoningRawContentEvent;
...
use hypercode_protocol::protocol::UserMessageEvent;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `hypercode-rs/core/rollout/policy.rs`.
...
mod tests {
    use super::*;
    use hypercode_protocol::protocol::AgentMessageEvent;
    use hypercode_protocol::protocol::AgentReasoningEvent;
    use hypercode_protocol::protocol::AgentReasoningRawContentEvent;
    use hypercode_protocol::protocol::ThreadRolledBackEvent;
