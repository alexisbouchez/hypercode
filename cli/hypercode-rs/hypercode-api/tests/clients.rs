...
use hypercode_api::ChatClient;
use hypercode_api::Provider;
use hypercode_api::ResponsesClient;
use hypercode_api::ResponsesOptions;
use hypercode_api::WireApi;
use hypercode_api::requests::responses::Compression;
use hypercode_client::HttpTransport;
use hypercode_client::Request;
use hypercode_client::Response;
use hypercode_client::StreamResponse;
use hypercode_client::TransportError;
...
fn provider(name: &str, wire: WireApi) -> Provider {
    Provider {
        ...
        wire,
        headers: HeaderMap::new(),
        retry: hypercode_api::provider::RetryConfig {
            max_attempts: 1,
...
async fn streaming_client_retries_on_transport_error() -> Result<()> {
    ...
    let prompt = hypercode_api::Prompt {
