...
impl Client {
    ...
    pub fn from_auth(base_url: impl Into<String>, auth: &HypercodeAuth) -> Result<Self> {
        let token = auth.get_token().map_err(anyhow::Error::from)?;
        let mut client = Self::new(base_url)?
            .with_user_agent(get_hypercode_user_agent())
    ...
    fn headers(&self) -> HeaderMap {
        ...
        if let Some(ua) = &self.user_agent {
            ...
            h.insert(USER_AGENT, HeaderValue::from_static("hypercode-cli"));
        }
    ...
    pub async fn get_rate_limits(&self) -> Result<RateLimitSnapshot> {
        let url = match self.path_style {
            PathStyle::HypercodeApi => format!("{}/api/hypercode/usage", self.base_url),
    ...
    pub async fn list_tasks(
        ...
        let url = match self.path_style {
            PathStyle::HypercodeApi => format!("{}/api/hypercode/tasks/list", self.base_url),
    ...
    pub async fn get_task_details_with_body(
        ...
        let url = match self.path_style {
            PathStyle::HypercodeApi => format!("{}/api/hypercode/tasks/{}", self.base_url, task_id),
    ...
    pub async fn list_sibling_turns(
        ...
        let url = match self.path_style {
            PathStyle::HypercodeApi => format!(
                "{}/api/hypercode/tasks/{}/turns/{}/sibling_turns",
    ...
    pub async fn create_task(&self, request_body: serde_json::Value) -> Result<String> {
        let url = match self.path_style {
            PathStyle::HypercodeApi => format!("{}/api/hypercode/tasks", self.base_url),
