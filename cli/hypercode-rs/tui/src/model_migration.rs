...
pub(crate) fn migration_copy_for_models(
    ...
    let heading_text = Span::from(format!(
        "Hypercode just got an upgrade. Introducing {target_display_name}."
    ))
    .bold();
...
impl ModelMigrationScreen {
    ...
    fn render_menu(&self, column: &mut ColumnRenderable) {
        column.push(Line::from(""));
        column.push(
            Paragraph::new("Choose how you'd like Hypercode to proceed.")
                .wrap(Wrap { trim: false })
                .inset(Insets::tlbr(0, 2, 0, 0)),
        );
        column.push(Line::from(""));
...
mod tests {
    ...
    fn prompt_snapshot() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                Some("Hypercode-optimized flagship for deep and fast reasoning.".to_string()),
                true,
            ),
        );
    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5",
                "gpt-5.1",
                Some("https://www.hypercode.com/models/gpt-5.1".to_string()),
                None,
                None,
                "gpt-5.1".to_string(),
    ...
    #[test]
    fn prompt_snapshot_gpt5_hypercode() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-hypercode",
                "gpt-5.1-codex-max",
                Some("https://www.hypercode.com/models/gpt-5.1-codex-max".to_string()),
                None,
                None,
                "gpt-5.1-codex-max".to_string(),
                Some("Hypercode-optimized flagship for deep and fast reasoning.".to_string()),
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt5_hypercode", terminal.backend());
    }

    #[test]
    fn prompt_snapshot_gpt5_hypercode_mini() {
        let backend = VT100Backend::new(60, 22);
        let mut terminal = Terminal::with_options(backend).expect("terminal");
        terminal.set_viewport_area(Rect::new(0, 0, 60, 22));
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                "gpt-5.1-codex-mini",
                Some("https://www.hypercode.com/models/gpt-5.1-codex-mini".to_string()),
                None,
                None,
                "gpt-5.1-codex-mini".to_string(),
                Some("Optimized for hypercode. Cheaper, faster, but less capable.".to_string()),
                false,
            ),
        );
        {
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt5_hypercode_mini", terminal.backend());
    }
    ...
    fn escape_key_accepts_prompt() {
        let mut screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-old",
                "gpt-new",
                Some("https://www.hypercode.com/models/gpt-new".to_string()),
                None,
                None,
                "gpt-new".to_string(),
