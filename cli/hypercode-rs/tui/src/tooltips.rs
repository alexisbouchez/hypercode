...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/openai/hypercode/main/announcement_tip.toml";
...
/// Pick a random tooltip to show to the user when starting Hypercode.
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Hypercode TUI.
...
[[announcements]]
content = "Welcome to Hypercode! Check out the new onboarding flow."
