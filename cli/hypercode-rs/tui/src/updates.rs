...
use hypercode_core::default_client::create_client;
...
const HOMEBREW_CASK_URL: &str =
    "https://raw.githubusercontent.com/Homebrew/homebrew-cask/HEAD/Casks/c/hypercode.rb";
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/openai/hypercode/releases/latest";
...
fn version_filepath(config: &Config) -> PathBuf {
    config.hypercode_home.join(VERSION_FILENAME)
}
