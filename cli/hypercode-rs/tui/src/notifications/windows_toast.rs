...
[Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier('Hypercode').Show($toast)
"#,
    )
}
...
mod tests {
    ...
    fn leaves_safe_text_unmodified() {
        assert_eq!(escape_for_xml("hypercode"), "hypercode");
