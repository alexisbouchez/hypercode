...
impl OutgoingMessageSender {
    ...
    pub(crate) async fn send_event_as_notification(
        ...
        self.send_notification(OutgoingNotification {
            method: "hypercode/event".to_string(),
...
// Additional mcp-specific data to be added to a [`hypercode_core::protocol::Event`] as notification.params._meta
...
mod tests {
    ...
    async fn test_send_event_as_notification() -> Result<()> {
        ...
        assert_eq!(method, "hypercode/event");
