...
#[derive(Clone)]
pub struct HypercodeFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for HypercodeFeedback {
    fn default() -> Self {
        Self::new()
    }
}

impl HypercodeFeedback {
    pub fn new() -> Self {
    ...
    pub fn snapshot(&self, session_id: Option<ThreadId>) -> HypercodeLogSnapshot {
        let bytes = {
...
pub struct HypercodeLogSnapshot {
    bytes: Vec<u8>,
    tags: BTreeMap<String, String>,
    pub thread_id: String,
}

impl HypercodeLogSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("hypercode-feedback-{}.log", self.thread_id);
    ...
    pub fn upload_feedback(
        ...
        if include_logs {
            envelope.add_item(EnvelopeItem::Attachment(Attachment {
                ...
                filename: String::from("hypercode-logs.log"),
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = HypercodeFeedback::with_capacity(8);
        {
