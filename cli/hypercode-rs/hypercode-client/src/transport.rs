use crate::default_client::HypercodeHttpClient;
use crate::default_client::HypercodeRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: HypercodeHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<HypercodeRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
