...
//!
//! See `hypercode-rs/tui2/docs/scroll_input_model.md` for the data-derived constants and analysis.

use hypercode_core::config::types::ScrollInputMode;
use hypercode_core::terminal::TerminalInfo;
use hypercode_core::terminal::TerminalName;
...
///
/// Most callers should construct this from the merged [`hypercode_core::config::Config`] fields so
...
impl MouseScrollState {
    ...
    ///
    /// Key details (see `hypercode-rs/tui2/docs/scroll_input_model.md` for the full model):
    ///
...
///
/// See `hypercode-rs/tui2/docs/scroll_input_model.md` for the full rationale and probe-derived
/// constants.
struct ScrollStream {
    start: Instant,
    last: Instant,
