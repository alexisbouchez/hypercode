...
//! transcript scroll state in `hypercode-tui2` is represented as a stable anchor
...
//!
//! Once `hypercode-tui2` upgrades to Ratatui 0.30 (and the workspace converges on a single `crossterm`
