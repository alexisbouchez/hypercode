...
//!
//! For the detailed burst state machine, see `hypercode-rs/tui2/src/bottom_pane/paste_burst.rs`.
...
use hypercode_common::fuzzy_match::fuzzy_match;
use hypercode_protocol::custom_prompts::CustomPrompt;
use hypercode_protocol::custom_prompts::PROMPTS_CMD_PREFIX;
use hypercode_protocol::models::local_image_label_text;
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            sender,
            false,
            "Ask Hypercode to do anything".to_string(),
            false,
        );
...
程序员 与 Unicode 同行";
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("hypercode_tui_test_paste_image.png");
