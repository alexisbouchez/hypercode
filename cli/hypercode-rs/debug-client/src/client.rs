...
use hypercode_app_server_protocol::UserInput;
use serde::Serialize;
...
impl AppServerClient {
    ...
    pub fn initialize(&mut self) -> Result<()> {
        ...
        let request = ClientRequest::Initialize {
            ...
            params: hypercode_app_server_protocol::InitializeParams {
        ...
        let _parsed: hypercode_app_server_protocol::InitializeResponse =
...
fn handle_server_request(
    ...
    let Ok(server_request) = hypercode_app_server_protocol::ServerRequest::try_from(request) else {
        return Ok(());
    };

    match server_request {
        hypercode_app_server_protocol::ServerRequest::CommandExecutionRequestApproval {
            request_id,
            ..
        } => {
            let response = hypercode_app_server_protocol::CommandExecutionRequestApprovalResponse {
                decision: CommandExecutionApprovalDecision::Decline,
            };
            send_jsonrpc_response(stdin, request_id, response)
        }
        hypercode_app_server_protocol::ServerRequest::FileChangeRequestApproval {
            request_id, ..
        } => {
            let response = hypercode_app_server_protocol::FileChangeRequestApprovalResponse {
