...
use hypercode_core::landlock::spawn_command_under_linux_sandbox;
#[cfg(target_os = "macos")]
use hypercode_core::seatbelt::spawn_command_under_seatbelt;
use hypercode_core::spawn::StdioPolicy;
...
pub async fn run_command_under_seatbelt(
    ...
    _hypercode_linux_sandbox_exe: Option<PathBuf>,
) -> anyhow::Result<()> {
...
async fn run_command_under_sandbox(
    ...
    if let SandboxType::Windows = sandbox_type {
        #[cfg(target_os = "windows")]
        {
            ...
            let base_dir = config.hypercode_home.clone();
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Landlock => {
            ...
            let hypercode_linux_sandbox_exe = config
                .hypercode_linux_sandbox_exe
                .expect("hypercode-linux-sandbox executable not found");
