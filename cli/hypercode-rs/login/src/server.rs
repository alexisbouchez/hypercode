...
use hypercode_core::default_client::originator;
use hypercode_core::token_data::TokenData;
use hypercode_core::token_data::parse_id_token;
use rand::RngCore;
...
fn build_authorize_url(
    ...
    let mut query = vec![
        ...
        ("hypercode_cli_simplified_flow".to_string(), "true".to_string()),
...
pub(crate) async fn persist_tokens_async(
    ...
    tokio::task::spawn_blocking(move || {
        ...
        save_auth(&hypercode_home, &auth, auth_credentials_store_mode)
    })
    .await
