...
use anyhow::Result;
use hypercode_core::MCP_SANDBOX_STATE_CAPABILITY;
...
impl ExecTool {
    ...
    async fn shell(
        ...
        let effective_timeout = Duration::from_millis(
            params
                .timeout_ms
                .unwrap_or(hypercode_core::exec::DEFAULT_EXEC_COMMAND_TIMEOUT_MS),
        );
...
#[derive(Default)]
pub struct HypercodeSandboxStateUpdateMethod;

impl rmcp::model::ConstString for HypercodeSandboxStateUpdateMethod {
...
impl ServerHandler for ExecTool {
    ...
    async fn on_custom_request(
        ...
        if method != MCP_SANDBOX_STATE_METHOD {
            return Err(McpError::method_not_found::<HypercodeSandboxStateUpdateMethod>());
        }
