...
async fn initialize_uses_client_info_name_as_originator() -> Result<()> {
    ...
    let message = timeout(
        ...
        mcp.initialize_with_client_info(ClientInfo {
            name: "hypercode_vscode".to_string(),
    ...
    assert!(user_agent.starts_with("hypercode_vscode/"));
    Ok(())
}
...
async fn initialize_respects_originator_override_env_var() -> Result<()> {
    ...
    let mut mcp = McpProcess::new_with_env(
        ...
        &[(
            ...
            Some("hypercode_originator_via_env_var"),
        )],
    )
    .await?;
    ...
    assert!(user_agent.starts_with("hypercode_originator_via_env_var/"));
    Ok(())
}
