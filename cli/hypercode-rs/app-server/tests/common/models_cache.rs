use chrono::DateTime;
use chrono::Utc;
use hypercode_core::models_manager::model_presets::all_model_presets;
...
/// Write a models_cache.json file to the hypercode home directory.
/// This prevents ModelsManager from making network requests to refresh models.
/// The cache will be treated as fresh (within TTL) and used instead of fetching from the network.
/// Uses the built-in model presets from ModelsManager, converted to ModelInfo format.
pub fn write_models_cache(hypercode_home: &Path) -> std::io::Result<()> {
    ...
    write_models_cache_with_models(hypercode_home, models)
}
...
pub fn write_models_cache_with_models(
    ...
    let cache_path = hypercode_home.join("models_cache.json");
