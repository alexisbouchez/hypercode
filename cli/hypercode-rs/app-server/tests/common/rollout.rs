...
use hypercode_protocol::protocol::GitInfo;
...
/// Create a minimal rollout file under `HYPERCODE_HOME/sessions/YYYY/MM/DD/`.
///
...
pub fn create_fake_rollout(
    ...
    let dir = hypercode_home.join("sessions").join(year).join(month).join(day);
    ...
    let meta = SessionMeta {
        ...
        cwd: PathBuf::from("/"),
        originator: "hypercode".to_string(),
