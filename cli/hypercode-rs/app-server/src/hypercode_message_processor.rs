...
use chrono::DateTime;
use chrono::Utc;
use hypercode_app_server_protocol::Account;
use hypercode_app_server_protocol::AccountLoginCompletedNotification;
use hypercode_app_server_protocol::AccountUpdatedNotification;
use hypercode_app_server_protocol::AddConversationListenerParams;
use hypercode_app_server_protocol::AddConversationSubscriptionResponse;
use hypercode_app_server_protocol::ArchiveConversationParams;
use hypercode_app_server_protocol::ArchiveConversationResponse;
use hypercode_app_server_protocol::AskForApproval;
use hypercode_app_server_protocol::AuthMode;
use hypercode_app_server_protocol::AuthStatusChangeNotification;
use hypercode_app_server_protocol::CancelLoginAccountParams;
use hypercode_app_server_protocol::CancelLoginAccountResponse;
use hypercode_app_server_protocol::CancelLoginAccountStatus;
use hypercode_app_server_protocol::CancelLoginChatGptResponse;
use hypercode_app_server_protocol::ClientRequest;
use hypercode_app_server_protocol::CommandExecParams;
use hypercode_app_server_protocol::ConversationGitInfo;
use hypercode_app_server_protocol::ConversationSummary;
use hypercode_app_server_protocol::ExecOneOffCommandResponse;
use hypercode_app_server_protocol::FeedbackUploadParams;
use hypercode_app_server_protocol::FeedbackUploadResponse;
use hypercode_app_server_protocol::ForkConversationParams;
use hypercode_app_server_protocol::ForkConversationResponse;
use hypercode_app_server_protocol::FuzzyFileSearchParams;
use hypercode_app_server_protocol::FuzzyFileSearchResponse;
use hypercode_app_server_protocol::GetAccountParams;
use hypercode_app_server_protocol::GetAccountRateLimitsResponse;
use hypercode_app_server_protocol::GetAccountResponse;
use hypercode_app_server_protocol::GetAuthStatusParams;
use hypercode_app_server_protocol::GetAuthStatusResponse;
use hypercode_app_server_protocol::GetConversationSummaryParams;
use hypercode_app_server_protocol::GetConversationSummaryResponse;
use hypercode_app_server_protocol::GetUserAgentResponse;
use hypercode_app_server_protocol::GetUserSavedConfigResponse;
use hypercode_app_server_protocol::GitDiffToRemoteResponse;
use hypercode_app_server_protocol::GitInfo as ApiGitInfo;
use hypercode_app_server_protocol::InputItem as WireInputItem;
use hypercode_app_server_protocol::InterruptConversationParams;
use hypercode_app_server_protocol::JSONRPCErrorError;
use hypercode_app_server_protocol::ListConversationsParams;
use hypercode_app_server_protocol::ListConversationsResponse;
use hypercode_app_server_protocol::ListMcpServerStatusParams;
use hypercode_app_server_protocol::ListMcpServerStatusResponse;
use hypercode_app_server_protocol::LoginAccountParams;
use hypercode_app_server_protocol::LoginApiKeyParams;
use hypercode_app_server_protocol::LoginApiKeyResponse;
use hypercode_app_server_protocol::LoginChatGptCompleteNotification;
use hypercode_app_server_protocol::LoginChatGptResponse;
use hypercode_app_server_protocol::LogoutAccountResponse;
use hypercode_app_server_protocol::LogoutChatGptResponse;
use hypercode_app_server_protocol::McpServerOauthLoginCompletedNotification;
use hypercode_app_server_protocol::McpServerOauthLoginParams;
use hypercode_app_server_protocol::McpServerOauthLoginResponse;
use hypercode_app_server_protocol::McpServerRefreshResponse;
use hypercode_app_server_protocol::McpServerStatus;
use hypercode_app_server_protocol::ModelListParams;
use hypercode_app_server_protocol::ModelListResponse;
use hypercode_app_server_protocol::NewConversationParams;
use hypercode_app_server_protocol::NewConversationResponse;
use hypercode_app_server_protocol::RemoveConversationListenerParams;
use hypercode_app_server_protocol::RemoveConversationSubscriptionResponse;
use hypercode_app_server_protocol::RequestId;
use hypercode_app_server_protocol::ResumeConversationParams;
use hypercode_app_server_protocol::ResumeConversationResponse;
use hypercode_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use hypercode_app_server_protocol::ReviewStartParams;
use hypercode_app_server_protocol::ReviewStartResponse;
use hypercode_app_server_protocol::ReviewTarget as ApiReviewTarget;
use hypercode_app_server_protocol::SandboxMode;
use hypercode_app_server_protocol::SendUserMessageParams;
use hypercode_app_server_protocol::SendUserMessageResponse;
use hypercode_app_server_protocol::SendUserTurnParams;
use hypercode_app_server_protocol::SendUserTurnResponse;
use hypercode_app_server_protocol::ServerNotification;
use hypercode_app_server_protocol::SessionConfiguredNotification;
use hypercode_app_server_protocol::SetDefaultModelParams;
use hypercode_app_server_protocol::SetDefaultModelResponse;
use hypercode_app_server_protocol::SkillsListParams;
use hypercode_app_server_protocol::SkillsListResponse;
use hypercode_app_server_protocol::Thread;
use hypercode_app_server_protocol::ThreadArchiveParams;
use hypercode_app_server_protocol::ThreadArchiveResponse;
use hypercode_app_server_protocol::ThreadForkParams;
use hypercode_app_server_protocol::ThreadForkResponse;
use hypercode_app_server_protocol::ThreadItem;
use hypercode_app_server_protocol::ThreadListParams;
use hypercode_app_server_protocol::ThreadListResponse;
use hypercode_app_server_protocol::ThreadLoadedListParams;
use hypercode_app_server_protocol::ThreadLoadedListResponse;
use hypercode_app_server_protocol::ThreadResumeParams;
use hypercode_app_server_protocol::ThreadResumeResponse;
use hypercode_app_server_protocol::ThreadRollbackParams;
use hypercode_app_server_protocol::ThreadStartParams;
use hypercode_app_server_protocol::ThreadStartResponse;
use hypercode_app_server_protocol::ThreadStartedNotification;
use hypercode_app_server_protocol::Turn;
use hypercode_app_server_protocol::TurnError;
use hypercode_app_server_protocol::TurnInterruptParams;
use hypercode_app_server_protocol::TurnStartParams;
use hypercode_app_server_protocol::TurnStartResponse;
use hypercode_app_server_protocol::TurnStartedNotification;
use hypercode_app_server_protocol::TurnStatus;
use hypercode_app_server_protocol::UserInfoResponse;
use hypercode_app_server_protocol::UserInput as V2UserInput;
use hypercode_app_server_protocol::UserSavedConfig;
use hypercode_app_server_protocol::build_turns_from_event_msgs;
use hypercode_backend_client::Client as BackendClient;
use hypercode_core::AuthManager;
use hypercode_core::HypercodeThread;
use hypercode_core::Cursor as RolloutCursor;
use hypercode_core::INTERACTIVE_SESSION_SOURCES;
use hypercode_core::InitialHistory;
use hypercode_core::NewThread;
use hypercode_core::RolloutRecorder;
use hypercode_core::SessionMeta;
...
use hypercode_core::config::edit::ConfigEditsBuilder;
use hypercode_core::config::types::McpServerTransportConfig;
use hypercode_core::default_client::get_hypercode_user_agent;
use hypercode_core::error::HypercodeErr;
use hypercode_core::exec::ExecParams;
use hypercode_core::exec_env::create_env;
use hypercode_core::features::Feature;
use hypercode_core::find_thread_path_by_id_str;
use hypercode_core::git_info::git_diff_to_remote;
use hypercode_core::mcp::collect_mcp_snapshot;
use hypercode_core::mcp::group_tools_by_server;
use hypercode_core::parse_cursor;
use hypercode_core::protocol::EventMsg;
use hypercode_core::protocol::Op;
use hypercode_core::protocol::ReviewDelivery as CoreReviewDelivery;
use hypercode_core::protocol::ReviewRequest;
use hypercode_core::protocol::ReviewTarget as CoreReviewTarget;
use hypercode_core::protocol::SessionConfiguredEvent;
use hypercode_core::read_head_for_summary;
use hypercode_core::sandboxing::SandboxPermissions;
use hypercode_feedback::HypercodeFeedback;
use hypercode_login::ServerOptions as LoginServerOptions;
...
use hypercode_protocol::items::TurnItem;
use hypercode_protocol::models::ResponseItem;
use hypercode_protocol::protocol::GitInfo as CoreGitInfo;
use hypercode_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use hypercode_protocol::protocol::McpServerRefreshConfig;
use hypercode_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use hypercode_protocol::protocol::RolloutItem;
use hypercode_protocol::protocol::SessionMetaLine;
use hypercode_protocol::protocol::USER_MESSAGE_BEGIN;
use hypercode_protocol::user_input::UserInput as CoreInputItem;
use hypercode_rmcp_client::perform_oauth_login_return_url;
...
/// Handles JSON-RPC messages for Hypercode threads (and legacy conversation APIs).
pub(crate) struct HypercodeMessageProcessor {
...
impl HypercodeMessageProcessor {
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<HypercodeThread>), JSONRPCErrorError> {
    ...
    fn review_request_from_target(
        ...
        let hint = hypercode_core::review_prompts::user_facing_hint(&core_target);
    ...
    pub async fn process_request(&mut self, request: ClientRequest) {
        match request {
            ...
            | ClientRequest::ConfigBatchWrite { .. } => {
                warn!("Config request reached HypercodeMessageProcessor unexpectedly");
            }
            ClientRequest::ConfigRequirementsRead { .. } => {
                warn!("ConfigRequirementsRead request reached HypercodeMessageProcessor unexpectedly");
            }
    ...
    async fn login_api_key_v2(&mut self, request_id: RequestId, params: LoginApiKeyParams) {
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = hypercode_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = hypercode_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn get_account(&self, request_id: RequestId, params: GetAccountParams) {
        ...
        let account = match self.auth_manager.auth_cached() {
            Some(auth) => Some(match auth.mode {
                ...
                AuthMode::Mistral => Account::ApiKey {},
                AuthMode::ChatGPT => {
    ...
    async fn fetch_account_rate_limits(&self) -> Result<CoreRateLimitSnapshot, JSONRPCErrorError> {
        let Some(auth) = self.auth_manager.auth().await else {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "hypercode account authentication required to read rate limits".to_string(),
                data: None,
            });
        };
        ...
        client
            ...
            .map_err(|err| JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: format!("failed to fetch hypercode rate limits: {err}"),
                data: None,
            })
    }

    async fn get_user_saved_config(&self, request_id: RequestId) {
        let service = ConfigService::new_with_defaults(self.config.hypercode_home.clone());
    ...
    async fn set_default_model(&self, request_id: RequestId, params: SetDefaultModelParams) {
        ...
        match ConfigEditsBuilder::new(&self.config.hypercode_home)
    ...
    async fn exec_one_off_command(&self, request_id: RequestId, params: CommandExecParams) {
        ...
        let hypercode_linux_sandbox_exe = self.config.hypercode_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        let req_id = request_id;
        let sandbox_cwd = self.config.cwd.clone();

        tokio::spawn(async move {
            match hypercode_core::exec::process_exec_tool_call(
                exec_params,
                &effective_policy,
                sandbox_cwd.as_path(),
                &hypercode_linux_sandbox_exe,
    ...
    async fn process_new_conversation(
        ...
        let typesafe_overrides = ConfigOverrides {
            ...
            sandbox_mode,
            model_provider,
            hypercode_linux_sandbox_exe: self.hypercode_linux_sandbox_exe.clone(),
            base_instructions,
            developer_instructions,
            compact_prompt,
            include_apply_patch_tool,
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<hypercode_app_server_protocol::AskForApproval>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(hypercode_app_server_protocol::AskForApproval::to_core),
    ...
    async fn thread_archive(&mut self, request_id: RequestId, params: ThreadArchiveParams) {
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.hypercode_home, &thread_id.to_string()).await
            {
                Ok(Some(p)) => p,
                Ok(None) => {
                    let error = JSONRPCErrorError {
            ...
            .await
        {
            ...
            Err(err) => {
                let (code, message) = match err {
                    HypercodeErr::Io(_) | HypercodeErr::Json(_) => (
                        INVALID_REQUEST_ERROR_CODE,
                        format!("failed to load rollout `{}`: {err}", rollout_path.display()),
                    ),
                    HypercodeErr::InvalidRequest(message) => (INVALID_REQUEST_ERROR_CODE, message),
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.hypercode_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match hypercode_core::find_thread_path_by_id_str(
                    &self.config.hypercode_home,
    ...
    async fn handle_resume_conversation(
        ...
        let thread_history = if let Some(path) = path {
            ...
            match find_thread_path_by_id_str(&self.config.hypercode_home, &conversation_id.to_string())
                .await
            {
                Ok(Some(found_path)) => {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.hypercode_home.join(hypercode_core::SESSIONS_SUBDIR);
        ...
        let result: std::io::Result<()> = async {
            let archive_folder = self
                .config
                .hypercode_home
                .join(hypercode_core::ARCHIVED_SESSIONS_SUBDIR);
    ...
    async fn skills_list(&self, request_id: RequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(hypercode_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
    ...
    async fn start_inline_review(
        &self,
        request_id: &RequestId,
        parent_thread: Arc<HypercodeThread>,
    ...
    async fn start_detached_review(
        ...
        let rollout_path =
            find_thread_path_by_id_str(&self.config.hypercode_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
                    ...
                    event = conversation.next_event() => {
                        ...
                        outgoing_for_task
                            .send_notification(OutgoingNotification {
                                method: format!("hypercode/event/{event_formatted}"),
...
fn skills_to_info(
    skills: &[hypercode_core::skills::SkillMetadata],
) -> Vec<hypercode_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| hypercode_app_server_protocol::SkillMetadata {
...
fn errors_to_info(
    errors: &[hypercode_core::skills::SkillError],
) -> Vec<hypercode_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| hypercode_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
pub(crate) async fn read_event_msgs_from_rollout(
    path: &Path,
) -> std::io::Result<Vec<hypercode_protocol::protocol::EventMsg>> {
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match hypercode_core::parse_turn_item(&item) {
...
mod tests {
    ...
    async fn read_summary_from_rollout_returns_empty_preview_when_no_user_message() -> Result<()> {
        use hypercode_protocol::protocol::RolloutItem;
        use hypercode_protocol::protocol::RolloutLine;
        use hypercode_protocol::protocol::SessionMetaLine;
        use std::fs;
