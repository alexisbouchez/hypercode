...
use hypercode_core::check_execpolicy_for_warnings;
...
mod hypercode_message_processor;
mod config_api;
mod error_code;
...
pub async fn run_main(
    ...
    let feedback = HypercodeFeedback::new();

    let otel = hypercode_core::otel_init::build_provider(
        &config,
