use crate::hypercode_message_processor::ApiVersion;
use crate::hypercode_message_processor::PendingInterrupts;
use crate::hypercode_message_processor::PendingRollbacks;
use crate::hypercode_message_processor::TurnSummary;
use crate::hypercode_message_processor::TurnSummaryStore;
use crate::hypercode_message_processor::read_event_msgs_from_rollout;
use crate::hypercode_message_processor::read_summary_from_rollout;
use crate::hypercode_message_processor::summary_to_thread;
use crate::error_code::INTERNAL_ERROR_CODE;
use crate::error_code::INVALID_REQUEST_ERROR_CODE;
use crate::outgoing_message::OutgoingMessageSender;
use hypercode_app_server_protocol::AccountRateLimitsUpdatedNotification;
use hypercode_app_server_protocol::AgentMessageDeltaNotification;
use hypercode_app_server_protocol::ApplyPatchApprovalParams;
use hypercode_app_server_protocol::ApplyPatchApprovalResponse;
use hypercode_app_server_protocol::HypercodeErrorInfo as V2HypercodeErrorInfo;
use hypercode_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use hypercode_app_server_protocol::CollabAgentTool;
use hypercode_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use hypercode_app_server_protocol::CommandAction as V2ParsedCommand;
use hypercode_app_server_protocol::CommandExecutionApprovalDecision;
use hypercode_app_server_protocol::CommandExecutionOutputDeltaNotification;
use hypercode_app_server_protocol::CommandExecutionRequestApprovalParams;
use hypercode_app_server_protocol::CommandExecutionRequestApprovalResponse;
use hypercode_app_server_protocol::CommandExecutionStatus;
use hypercode_app_server_protocol::ContextCompactedNotification;
use hypercode_app_server_protocol::DeprecationNoticeNotification;
use hypercode_app_server_protocol::ErrorNotification;
use hypercode_app_server_protocol::ExecCommandApprovalParams;
use hypercode_app_server_protocol::ExecCommandApprovalResponse;
use hypercode_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use hypercode_app_server_protocol::FileChangeApprovalDecision;
use hypercode_app_server_protocol::FileChangeOutputDeltaNotification;
use hypercode_app_server_protocol::FileChangeRequestApprovalParams;
use hypercode_app_server_protocol::FileChangeRequestApprovalResponse;
use hypercode_app_server_protocol::FileUpdateChange;
use hypercode_app_server_protocol::InterruptConversationResponse;
use hypercode_app_server_protocol::ItemCompletedNotification;
use hypercode_app_server_protocol::ItemStartedNotification;
use hypercode_app_server_protocol::JSONRPCErrorError;
use hypercode_app_server_protocol::McpToolCallError;
use hypercode_app_server_protocol::McpToolCallResult;
use hypercode_app_server_protocol::McpToolCallStatus;
use hypercode_app_server_protocol::PatchApplyStatus;
use hypercode_app_server_protocol::PatchChangeKind as V2PatchChangeKind;
use hypercode_app_server_protocol::RawResponseItemCompletedNotification;
use hypercode_app_server_protocol::ReasoningSummaryPartAddedNotification;
use hypercode_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use hypercode_app_server_protocol::ReasoningTextDeltaNotification;
use hypercode_app_server_protocol::ServerNotification;
use hypercode_app_server_protocol::ServerRequestPayload;
use hypercode_app_server_protocol::TerminalInteractionNotification;
use hypercode_app_server_protocol::ThreadItem;
use hypercode_app_server_protocol::ThreadRollbackResponse;
use hypercode_app_server_protocol::ThreadTokenUsage;
use hypercode_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use hypercode_app_server_protocol::Turn;
use hypercode_app_server_protocol::TurnCompletedNotification;
use hypercode_app_server_protocol::TurnDiffUpdatedNotification;
use hypercode_app_server_protocol::TurnError;
use hypercode_app_server_protocol::TurnInterruptResponse;
use hypercode_app_server_protocol::TurnPlanStep;
use hypercode_app_server_protocol::TurnPlanUpdatedNotification;
...
use hypercode_core::parse_command::shlex_join;
use hypercode_core::protocol::ApplyPatchApprovalRequestEvent;
use hypercode_core::protocol::HypercodeErrorInfo as CoreHypercodeErrorInfo;
...
use hypercode_core::protocol::FileChange as CoreFileChange;
...
use hypercode_core::protocol::TokenCountEvent;
use hypercode_core::protocol::TurnDiffEvent;
use hypercode_core::review_format::format_review_findings_block;
use hypercode_core::review_prompts;
use hypercode_protocol::ThreadId;
use hypercode_protocol::plan_tool::UpdatePlanArgs;
use hypercode_protocol::protocol::ReviewOutputEvent;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<HypercodeThread>,
    ...
    match msg {
        ...
        EventMsg::CollabAgentInteractionEnd(end_event) => {
            let status = match end_event.status {
                hypercode_protocol::protocol::AgentStatus::Errored(_)
                | hypercode_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        ...
        EventMsg::Error(ev) => {
            ...
            let hypercode_error_info = ev.hypercode_error_info.clone();
            ...
            if matches!(
                hypercode_error_info,
                Some(CoreHypercodeErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                hypercode_error_info: ev.hypercode_error_info.map(V2HypercodeErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: hypercode_protocol::models::ResponseItem,
    outgoing: &OutgoingMessageSender,
) {
...
async fn on_exec_approval_response(
    ...
    // Try to deserialize `value` and then make the appropriate call to `hypercode`.
    let response =
...
mod tests {
    ...
    use anyhow::anyhow;
    use anyhow::bail;
    use hypercode_app_server_protocol::TurnPlanStepStatus;
    use hypercode_core::protocol::CreditsSnapshot;
    use hypercode_core::protocol::McpInvocation;
    use hypercode_core::protocol::RateLimitSnapshot;
    use hypercode_core::protocol::RateLimitWindow;
    use hypercode_core::protocol::TokenUsage;
    use hypercode_core::protocol::TokenUsageInfo;
    use hypercode_protocol::plan_tool::PlanItemArg;
    use hypercode_protocol::plan_tool::StepStatus;
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                hypercode_error_info: Some(V2HypercodeErrorInfo::InternalServerError),
                additional_details: None,
            },
            &turn_summary_store,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                hypercode_error_info: Some(V2HypercodeErrorInfo::Other),
                additional_details: None,
            },
            &turn_summary_store,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                hypercode_error_info: Some(V2HypercodeErrorInfo::BadRequest),
                additional_details: None,
            },
            &turn_summary_store,
        )
