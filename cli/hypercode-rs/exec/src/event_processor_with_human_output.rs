use hypercode_common::elapsed::format_duration;
use hypercode_common::elapsed::format_elapsed;
...
use hypercode_protocol::num_format::format_with_separators;
...
use hypercode_common::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<hypercode_core::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(
        ...
        ts_msg!(
            self,
            "OpenAI Hypercode v{} (research preview)\n--------",
            VERSION
        );
    ...
    fn process_event(&mut self, event: Event) -> HypercodeStatus {
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    hypercode_core::protocol::McpStartupStatus::Starting => "starting".to_string(),
                    hypercode_core::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    hypercode_core::protocol::McpStartupStatus::Cancelled => "cancelled".to_string(),
                    hypercode_core::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
            ...
            EventMsg::TurnComplete(TurnCompleteEvent { last_agent_message }) => {
                ...
                return HypercodeStatus::InitiateShutdown;
            }
            ...
            EventMsg::AgentReasoningSectionBreak(_) => {
                if !self.show_agent_reasoning {
                    return HypercodeStatus::Running;
                }
                eprintln!();
            }
            ...
            EventMsg::AgentMessage(AgentMessageEvent { message }) => {
                ts_msg!(
                    self,
                    "{}\n{}",
                    "hypercode".style(self.italic).style(self.magenta),
                    message,
                );
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_msg!(
                    self,
                    "{} {}",
                    "hypercode session".style(self.magenta).style(self.bold),
            ...
            EventMsg::ShutdownComplete => return HypercodeStatus::Shutdown,
