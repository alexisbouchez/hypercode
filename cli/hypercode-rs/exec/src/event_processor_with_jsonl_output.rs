...
pub struct EventProcessorWithJsonOutput {
    ...
    last_total_token_usage: Option<hypercode_core::protocol::TokenUsage>,
...
impl EventProcessor for EventProcessorWithJsonOutput {
    ...
    fn process_event(&mut self, event: protocol::Event) -> HypercodeStatus {
