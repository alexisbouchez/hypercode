...
def define_struct(
    ...
    # Special-case: add Hypercode-specific user_agent to Implementation
    if name == "Implementation":
        fields.append(
            StructField(
                ...
                '#[ts(optional)]',
                "This is an extra field that the Hypercode MCP server sends as part of InitializeResult.",
            )
        )
