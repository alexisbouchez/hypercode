...
use hypercode_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "HypercodeSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Hypercode sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(hypercode_home);
