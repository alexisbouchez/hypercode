...
const OFFLINE_BLOCK_RULE_NAME: &str = "hypercode_sandbox_offline_block_outbound";

// Friendly text shown in the firewall UI.
const OFFLINE_BLOCK_RULE_FRIENDLY: &str = "Hypercode Sandbox Offline - Block Outbound";
