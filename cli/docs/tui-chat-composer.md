...
- `hypercode-rs/tui/src/bottom_pane/chat_composer.rs`
- `hypercode-rs/tui2/src/bottom_pane/chat_composer.rs`

Paste-burst detector:

- `hypercode-rs/tui/src/bottom_pane/paste_burst.rs`
- `hypercode-rs/tui2/src/bottom_pane/paste_burst.rs`
