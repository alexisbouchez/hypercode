...
3. **Document behavior.** If your change affects user-facing behavior, update the README, inline help (`hypercode --help`), or relevant example projects.
