...
This document describes how exit, shutdown, and interruption work in the Rust TUIs (`hypercode-rs/tui`
and `hypercode-rs/tui2`). It is intended for Hypercode developers and Hypercode itself when reasoning about
...
Hypercode has historically mixed "exit immediately" and "shutdown-first" across quit gestures, largely
