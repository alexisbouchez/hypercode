...
| Action                                     | Command                                  |
| ------------------------------------------ | ---------------------------------------- |
| Run a command in a specific package        | `pnpm --filter @openai/hypercode run build`  |
| Install a dependency in a specific package | `pnpm --filter @openai/hypercode add lodash` |
...
├── hypercode-cli/             # Main package
│   └── package.json       # hypercode-cli specific dependencies
