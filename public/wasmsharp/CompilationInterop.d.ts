...
export declare const enum CharacterOperation {
    None = 0,
    Inserted = 1,
    Deleted = 2
}
export declare class CompilationInterop {
    ...
    ShouldTriggerCompletionsAsync(compilationId: CompilationId, caretPosition: number, char: string, operation: CharacterOperation): Promise<boolean>;
    ShouldTriggerCompletionsAsync(compilationId: CompilationId, caretPosition: number, char?: string, operation?: CharacterOperation): Promise<boolean>;
